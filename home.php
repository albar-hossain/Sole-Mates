    ...
    <form action="Views/cart.php">
        <div class="nav">
            ...
            <div class="nav-icons">
                ...
                <a href="Views/myCart.php"><i class="fa-solid fa-cart-shopping"><span
                            class="item_count"><?php echo $count ?></span></i></a>
                <div class="logout">
                    <?php if ($username != "Guest") { ?>
                        <?php echo "<a href='Views/logout.php'> Welcome $username, Logout?</a>" ?>
                    <?php } else { ?>
                        <?php echo "<a href='Views/logout.php'> Welcome $username</a>" ?>
                    <?php } ?>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            <div class="Homebox1">
                ...
                <p>Take a look at some of our popular products.</p>
                <div class="rec1">
